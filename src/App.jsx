  ...
  return (
    <div className="page-wrapper">
      <div className="projects-grid">
        {projects.map((p, i) => (
          <div key={i} className="flip-card-3d-large animate-item" style={{ animationDelay: `${0.1 + i * 0.08}s` }} onClick={() => openModal(p.title, p.desc)}>
            <div className="flip-card-inner-large">
              <div className="flip-card-front-large">
...
function Experience() {
  ...
  return (
    <>
      <div className="three-column-grid">
        {experiences.map((exp, i) => (
          <div key={i} className="flip-card-exp-large animate-item" style={{ animationDelay: `${0.1 + i * 0.1}s` }} onClick={() => { setModalData({ title: exp.title, desc: `${exp.period}\n\n${exp.desc}` }); setShowModal(true); }}>
            <div className="flip-card-exp-inner-large">
              <div className="flip-card-exp-front-large">
                <div className="card-icon-3d"><i className="fas fa-briefcase"></i></div>
                <h4>{exp.title}</h4>
...
function Education() {
  ...
  return (
    <>
      <div className="two-column-grid">
        {educations.map((edu, i) => (
          <div key={i} className="flip-card-exp-medium animate-item" style={{ animationDelay: `${0.1 + i * 0.1}s` }} onClick={() => { setModalData({ title: edu.title, desc: `${edu.school}\n${edu.period}\n\n${edu.desc}` }); setShowModal(true); }}>
            <div className="flip-card-exp-inner-medium">
              <div className="flip-card-exp-front-medium">
                <div className="card-icon-3d"><i className="fas fa-graduation-cap"></i></div>
                <h4>{edu.title}</h4>
...
function Certificates() {
  ...
  return (
    <>
      <div className="two-column-grid">
        {certificates.map((cert, i) => (
          <div key={i} className="flip-card-exp-medium animate-item" style={{ animationDelay: `${0.1 + i * 0.1}s` }} onClick={() => { setModalData({ title: cert.title, desc: `${cert.issuer}\n\n${cert.desc}` }); setShowModal(true); }}>
            <div className="flip-card-exp-inner-medium">
              <div className="flip-card-exp-front-medium">
                <div className="card-icon-3d"><i className="fas fa-certificate"></i></div>
                <h4>{cert.title}</h4>
...
function Contact() {
  ...
  return (
    <>
      <div className="two-column-grid">
        {contacts.map((contact, i) => (
          <div key={i} className="flip-card-exp-medium animate-item" style={{ animationDelay: `${0.1 + i * 0.1}s` }} onClick={() => { setModalData({ title: contact.title, desc: `${contact.value}\n\n${contact.desc}` }); setShowModal(true); }}>
            <div className="flip-card-exp-inner-medium">
              <div className="flip-card-exp-front-medium">
                <div className="card-icon-3d"><i className={contact.icon}></i></div>
                <h4>{contact.title}</h4>
      ...
      <div className="unified-container">
        <div className="main-glass-card-3d">
          ...
          <div className={`page-transition ${transitionDirection}`}>
            <div className="content-3d">
              {pages[currentPage]}
              <div className="footer-3d">© 2025 Reynaldo B. Lumbres — Sa tahanan ng malakas ako ang pinakamalakas</div>
            </div>
          </div>
        </div>
      </div>
